...
public class FlatPriceStrategyTest {
  @Test
  public void getBidPriceTest() {
    ...
    final FlatPriceStrategy customStrategy = new FlatPriceStrategy();
    for (int attempt = 0; attempt < 10; attempt++) {
      Assert.assertEquals(customStrategy.getBidPriceMicrosUSD(adcandidate, bidRequest), 455);
    }
  }
}
